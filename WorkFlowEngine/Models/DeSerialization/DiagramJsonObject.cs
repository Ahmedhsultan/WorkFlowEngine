namespace WorkFlowEngine.Models.DeSerialization
{
    ...
    public class Selectedobject
    {
        ...
        public string umlIndex { get; set; }
    ...
    public class Layer
    {
        ...
        public string zIndex { get; set; }
        public string objectZIndex { get; set; }
    }
    ...
    public class Connector
    {
        ...
        public string flip { get; set; }
        public string connectorSpacing { get; set; }
        ...
        public bool visible { get; set; }
        public string constraints { get; set; }
        public string connectionPadding { get; set; }
        public string hitPadding { get; set; }
        public string sourcePadding { get; set; }
